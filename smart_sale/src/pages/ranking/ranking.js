          ...
          <div className="ranking_pag">
            <div className="div">
              <section className="descricao">
                ...
                <br />
                <p>Este ranking mostra os clientes que mais fizeram compras em nossa aplicação, merecem ser
                  ...
                  desses produtos.</p>
                <br />
                <p>Você pode estar em uma boa colocação no ranking ao comprar produtos com pontos, quanto mais
                  produtos você comprar, mais pontos você acumula. Dessa forma, é incentivado a compra de produtos
                  não destinados à doação para que não haja desperdício desse produto por conta de venda.</p>
                <br />
                <p>A causa desse ranking é apresentar os compradores preocupados com a causa, quem opta por
            ...
            <div className="botao">
              <a href="perfil.html" className="a-botao" title="Ir para o perfil">Descubra a sua pontuação em seu perfil!</a>
            </div>
          </div>
        </main>
        <Footer />
