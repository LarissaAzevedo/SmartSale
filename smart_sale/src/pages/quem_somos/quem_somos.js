              ...
              <div>
                <section className="quemsomos_texto_one">
                  ...
                  <p>
                    ...
                    benefícios,
                    um ranking apresenta a colocação de quem utiliza a aplicação e efetua doações.</p>
                </section>
              </div>
            </div>
          </div>
          <div className="quemsomos_partetwo">
            <section className="quemsomos_texto_two">
              <div className="quemsomos_esquerdo">
                <h2>Quem somos</h2>
                <p>A Smart Sale é uma aplicação brasileira que visa a redução do desperdício de alimentos visando pequenos e médios varejistas.
                  Nosso diferencial é a possiilidade os alimentos irem para ONGS ligadas a aplicação.</p>
                <h2>O que propomos</h2>
                <p>Propomos a redução do desperdício de alimentos perto de sua validade. Atuamos no ramo alimenticio e de vestuário.</p>
              </div>
