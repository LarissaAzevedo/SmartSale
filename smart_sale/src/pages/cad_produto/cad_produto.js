                      ...
                      function (e) {
                        return (
                          <tr key={e.idProduto}>
                            ...
                            <td>
                              <MDBBtn color="primary" size="sm" onClick={() => this.alterarProduto(e)}>Alterar</MDBBtn>
                              <MDBBtn color="danger" size="sm" onClick={() => this.deletarProduto(e.idProduto)}>Deletar</MDBBtn>
                            </td>
                          </tr>
                        )
                      }.bind(this))
