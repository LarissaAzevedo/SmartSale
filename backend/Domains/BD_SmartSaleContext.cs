...
namespace backend.Domains {
  public partial class BD_SmartSaleContext : DbContext {
    ...
    public BD_SmartSaleContext (DbContextOptions<BD_SmartSaleContext> options) : base (options) { }
    ...
    protected override void OnConfiguring (DbContextOptionsBuilder optionsBuilder) {
      if (!optionsBuilder.IsConfigured) {
        optionsBuilder.UseSqlServer ("Server=localhost;Database=BD_SmartSale;Trusted_Connection=True");
      }
    }
